    ...
    return (
        <div className="flex gap-4">
            <button
                ...
                className={`w-full flex items-center justify-center gap-x-3 p-2.5 border border-black/10 rounded-lg whitespace-nowrap text-sm font-medium cursor-pointer hover:bg-black/5`}>
